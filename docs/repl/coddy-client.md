...
O próximo passo de desacoplamento é mover `apps/coddy`, `crates/coddy-core`, `crates/coddy-ipc`, `crates/coddy-client` e `crates/coddy-voice-input` para o repositório Coddy mantendo o socket do daemon como fronteira.
