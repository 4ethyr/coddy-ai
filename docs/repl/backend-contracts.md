...
- `crates/coddy-voice-input`: captura/transcrição de voz local e overlay com configuração neutra `VoiceInputConfig`.
...
3. CLI captura/transcreve audio local via `coddy-voice-input`.
