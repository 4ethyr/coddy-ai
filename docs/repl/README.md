...
- [Manifesto de Separação](repository-split-manifest.md): lista objetiva do que vai para o repositório Coddy, o que fica no VisionClip e quais variáveis/protocolos formam a fronteira.
